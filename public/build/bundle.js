...
var cojamApp = (function () {
    ...
    /* src\Components\IndexPage\IndexPage.svelte generated by Svelte v3.24.1 */

    const file$1 = "src\\Components\\IndexPage\\IndexPage.svelte";
    ...
    function instance$3($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<IndexPage> was created with unknown prop '${key}'`);
    	});
    ...
    /* src\Components\App\App.svelte generated by Svelte v3.24.1 */
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Link, Route, IndexPage });
    	return [];
    }
